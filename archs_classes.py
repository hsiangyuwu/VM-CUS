...
import torchvision
from hardnet_classes import hardnet
...
class HarDMSEG(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.up = nn.ConvTranspose2d(4, 4, 8, stride=8, padding=0)
        
    def forward(self, x):
        #print("input",x.size())
        
        hardnetout, classout = self.hardnet(x)
        ...
        x4_rfb = self.rfb4_1(x4)        # channel 1024-> 32
        ...
        #lateral_map_5 = self.up(ra5_feat)
        #print(lateral_map_5.size())
        lateral_map_5 = F.interpolate(ra5_feat, scale_factor=8, mode='bicubic', align_corners=True)    # NOTES: Sup-1 (bs, 1, 44, 44) -> (bs, 1, 352, 352)
        return lateral_map_5, classout #, lateral_map_4, lateral_map_3, lateral_map_2
